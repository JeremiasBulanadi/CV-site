...
var app = (function () {
    ...
    const file$5 = "src\\components\\Tab.svelte";
    ...
    class Tab extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$5, create_fragment$5, safe_not_equal, { tabName: 0 });
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$3, 56, 16, 1588);
    			attr_dev(div1, "class", "nav-side flex");
    			add_location(div1, file$3, 55, 12, 1543);
    			attr_dev(div2, "class", "tabs-container flex");
    			add_location(div2, file$3, 61, 16, 1763);
    			...
    			add_location(nav, file$3, 53, 4, 1353);
    			attr_dev(header, "class", "svelte-7r8nzt");
    			add_location(header, file$3, 52, 0, 1339);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Navbar extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { duration: 3, offset: 4, tolerance: 5 });
