...
var app = (function () {
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$6, 7, 8, 165);
    ...
    class Tab extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$6, create_fragment$6, safe_not_equal, { tabName: 0 });
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$4, 56, 16, 1588);
    			attr_dev(div1, "class", "nav-side flex");
    			add_location(div1, file$4, 55, 12, 1543);
    			attr_dev(div2, "class", "tabs-container flex");
    			add_location(div2, file$4, 61, 16, 1763);
    			...
    			add_location(button, file$4, 68, 24, 2121);
    			attr_dev(a, "href", "./JeremiasBulanadi-Resume.pdf");
    			attr_dev(a, "target", "_blank");
    			add_location(a, file$4, 67, 20, 2039);
    			attr_dev(div3, "class", "flex items-center px-6");
    			add_location(div3, file$4, 66, 16, 1981);
    			attr_dev(div4, "class", "nav-side flex items-stretch");
    			add_location(div4, file$4, 60, 12, 1704);
    			attr_dev(div5, "id", "nav-content");
    			attr_dev(div5, "class", "flex justify-between svelte-7r8nzt");
    			add_location(div5, file$4, 54, 8, 1478);
    			attr_dev(nav, "id", "navbar");
    			attr_dev(nav, "class", nav_class_value = "bg-gray-200 bg-opacity-80 fixed top-0 left-0 z-50 " + /*headerClass*/ ctx[1] + " svelte-7r8nzt");
    			add_location(nav, file$4, 53, 4, 1353);
    			attr_dev(header, "class", "svelte-7r8nzt");
    			add_location(header, file$4, 52, 0, 1339);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*headerClass*/ 2 && nav_class_value !== (nav_class_value = "bg-gray-200 bg-opacity-80 fixed top-0 left-0 z-50 " + /*headerClass*/ ctx[1] + " svelte-7r8nzt")) {
    ...
    class Navbar extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { duration: 3, offset: 4, tolerance: 5 });
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$3, 18, 12, 802);
    			attr_dev(a, "href", "./JeremiasBulanadi-Resume.pdf");
    			attr_dev(a, "target", "_blank");
    			add_location(a, file$3, 17, 8, 732);
    			attr_dev(div1, "class", "button-container svelte-1ysctf2");
    			add_location(div1, file$3, 16, 4, 692);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "font-roboto font-extrabold text-3xl svelte-jy441u");
    			add_location(h2, file$2, 6, 8, 163);
    			attr_dev(div0, "class", "section-header flex flex-row items-center py-4 svelte-jy441u");
    			add_location(div0, file$2, 5, 4, 93);
    			attr_dev(p0, "class", "font-roboto mb-3 svelte-jy441u");
    			add_location(p0, file$2, 10, 12, 360);
    			attr_dev(p1, "class", "font-roboto mb-3 svelte-jy441u");
    			add_location(p1, file$2, 16, 12, 722);
    			attr_dev(p2, "class", "font-roboto svelte-jy441u");
    			add_location(p2, file$2, 21, 12, 1018);
    			add_location(li0, file$2, 25, 16, 1204);
    			add_location(li1, file$2, 28, 16, 1281);
    			add_location(li2, file$2, 31, 16, 1358);
    			add_location(li3, file$2, 34, 16, 1432);
    			add_location(li4, file$2, 37, 16, 1505);
    			add_location(li5, file$2, 40, 16, 1578);
    			add_location(li6, file$2, 43, 16, 1650);
    			add_location(li7, file$2, 46, 16, 1722);
    			add_location(li8, file$2, 49, 16, 1791);
    			attr_dev(ul, "class", "font-readex text-xs mt-5 ml-5 svelte-jy441u");
    			add_location(ul, file$2, 24, 12, 1144);
    			add_location(article, file$2, 9, 8, 337);
    			attr_dev(div1, "class", "image-holder bg-gray-500 flex justify-center items-center svelte-jy441u");
    			add_location(div1, file$2, 55, 12, 2017);
    			attr_dev(div2, "class", "image-container flex justify-center items-center m-9 bg-gray-500 text-white font-lato font-bold svelte-jy441u");
    			add_location(div2, file$2, 54, 8, 1894);
    			attr_dev(div3, "class", "article-container flex flex-col sm:flex-row justify-center items-center svelte-jy441u");
    			add_location(div3, file$2, 8, 4, 242);
    			attr_dev(section, "id", "About");
    			attr_dev(section, "class", "flex flex-col justify-center py-4 svelte-jy441u");
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(i0, "class", "fab fa-github fa-2x text-gray-600 hover:text-indigo-600 transform transition svelte-1gzexvx");
    			add_location(i0, file$1, 11, 12, 405);
    			attr_dev(a0, "href", "https://github.com/JeremiasBulanadi");
    			attr_dev(a0, "target", "_blank");
    			add_location(a0, file$1, 10, 8, 329);
    			attr_dev(div0, "class", "icon svelte-1gzexvx");
    			add_location(div0, file$1, 9, 4, 301);
    			attr_dev(i1, "class", "fab fa-linkedin-in fa-2x text-gray-600 hover:text-indigo-600 transform transition svelte-1gzexvx");
    			add_location(i1, file$1, 16, 12, 654);
    			attr_dev(a1, "href", "https://www.linkedin.com/in/jeremias-bulanadi-25b5a915a/");
    			attr_dev(a1, "target", "_blank");
    			add_location(a1, file$1, 15, 8, 557);
    			attr_dev(div1, "class", "icon svelte-1gzexvx");
    			add_location(div1, file$1, 14, 4, 529);
    			attr_dev(i2, "class", "fab fa-codepen fa-2x text-gray-600 hover:text-indigo-600 transform transition svelte-1gzexvx");
    			add_location(i2, file$1, 21, 12, 887);
    			attr_dev(a2, "href", "https://codepen.io/jeremiasbulanadi");
    			attr_dev(a2, "target", "_blank");
    			add_location(a2, file$1, 20, 8, 811);
    			attr_dev(div2, "class", "icon svelte-1gzexvx");
    			add_location(div2, file$1, 19, 4, 783);
    			attr_dev(i3, "class", "fas fa-at fa-2x text-gray-600 hover:text-indigo-600 transform transition svelte-1gzexvx");
    			add_location(i3, file$1, 26, 12, 1106);
    			attr_dev(a3, "href", "mailto:jdb.prog@gmail.com");
    			attr_dev(a3, "target", "_blank");
    			add_location(a3, file$1, 25, 8, 1040);
    			attr_dev(div3, "class", "icon svelte-1gzexvx");
    			add_location(div3, file$1, 24, 4, 1012);
    			attr_dev(div4, "class", "icon-bar flex flex-col svelte-1gzexvx");
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 17, 4, 495);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 27, 3, 722);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 21, 2, 593);
    			attr_dev(div1, "class", "container wrapper sm:px-1 svelte-yaeynw");
    			add_location(div1, file, 15, 1, 429);
    			attr_dev(main, "class", "bg-gray-200 flex justify-center svelte-yaeynw");
    			add_location(main, file, 14, 0, 380);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
